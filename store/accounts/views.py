...
from store.decorators import anonymous_required
from store.catalog.views import CatalogBaseView
from store.accounts.forms import RegisterForm, PasswordResetForm, ChangePasswordForm
from store.utils.helpers import send_mail
