...
from store.catalog.forms import AdvancedSearchForm
from store.catalog.models import Manufacturer, Category, Product
from store.financial.models import Currency
...
class CatalogBaseView(BaseView):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.primary_currency is None:
            raise ImproperlyConfigured('No primary currency is defined for store.'
