...
from store.financial.models import Tax
...
class Manufacturer(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('catalog_manufacturer', args = (self.slug,))
...
class Product(models.Model):
    ...
    name = models.CharField(max_length=100, unique=True)
    slug = models.SlugField(max_length=100, unique=True)
    brand = models.ForeignKey(Manufacturer, help_text='Manufacturer', on_delete=models.CASCADE)
    ...
    tax = models.ForeignKey(
        Tax, null=True, blank=True,  help_text='Tax applied on this product, if tax exempt select none', on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse('catalog_product', args = (self.id, self.slug,),)
...
class ProductPic(models.Model):
    ...
    """
    product = models.ForeignKey(Product, related_name='pics', on_delete=models.CASCADE)
