...
class Page(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('pages_page_view', args=(self.slug))
...
class Link(models.Model):
    ...
    page = models.ForeignKey(Page, blank=True, null=True, help_text='Page resource this link points to.', on_delete=models.CASCADE)
    updated_by = models.CharField(max_length=100)
